    ...
    constructor(props, context) {
        ...
        this.state = {
            ...
            collapse: {
                ...
                tables: this.routeActive(['table-standard', 'table-extended', 'table-datatable', 'table-jqgrid', 'table-versusScreen']),
                            ...
                            <li className={ this.routeActive(['table-standard', 'table-extended', 'table-datatable', 'table-jqgrid']) ? 'active' : '' }>
                                ...
                                <Collapse in={ this.state.collapse.tables }>
                                    <ul id="" className="nav sidebar-subnav">
                                        ...
                                        <li className={ this.routeActive('table-versusScreen') ? 'active' : '' }>
                                            <Link to="table-versusScreen" title="VersusScreen">
                                            <span>VersusScreen</span>
                                            </Link>
                                        </li>
                                    </ul>
                                </Collapse>
